            ...
            $(document).ready(function () {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        while (i < data.length){
                            $("#report").append("<hr>");
                            $("#report").append("<table class='table table-borderless' style='table-layout: fixed; width: 125%'><tr><td><b>Patient ID:</b> "+data[i].PatientID+" </td><td><b>Patient Name:</b> "+data[i].firstname+" "+data[i].lastname+" </td><td></td></tr> " +
                                "<tr><td colspan='3'><b>Address:</b> "+data[i].street+", "+data[i].suburb+", "+data[i].city+"</td></tr> " +
                                "<tr><td><b>Email:</b> "+data[i].email+" </td><td><b>Phone Number</b>: "+data[i].phone+" </td><td><b>Insurance Code</b>: "+data[i].insurcode+" </td></tr> " +
                                "<tr><td><b>Complete Admissions:</b> "+data[i].complete+" </td><td><b>Current Admissions:</b> "+data[i].current+"</td><td></td></tr></table>");
                            $("#report").append("<hr>");
                            i++;
                        }
                    },
