                        ...
                        $("#getInvoice").change(function() {
                            ...
                            while (i < data.length) {
                                if (data[i].AdmissionID == $("#getInvoice").val()) {
                                    $("#invoice").append("<table class='table'><tr><td>" + data[i].patient.id + "</td><td>" + data[i].patient.firstname + " " + data[i].patient.lastname + "</td></tr><tr><td>" + data[i].patient.address + "</td></tr></table>");
