    ...
    <div id="updateAdmission" class="container tab-pane fade"><br>
        <form action="../api/apiUpdateAdmission.php" method="post">
            ...
            <table>
                <tr>
                    <td><label>Description:* </label></td>
                    <td><input type="text" id="updateDescription" name="updateDescription" size="30" required></td>
                </tr>

                <tr>
                    <td><label>Admission Date:* </label></td>
                    <td><input type="date" id="updateAdmissionDate" name="updateAdmissionDate" required></td>
                </tr>
