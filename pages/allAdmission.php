                        ...
                        $("#getInvoice").change(function() {
                            ...
                            while (i < data.length) {
                                if (data[i].AdmissionID == $("#getInvoice").val()) {
                                    ...
                                    subtotal = 0;
                                    while (m < data[i].medication.length) {
                                        $("#invoice").append("<table class='table'><tr><td>Medication: " + data[i].medication[m].name + "</td><td>Quantity: " + data[i].medication[m].amount + "</td><td class='float-right'>Cost: $" + data[i].medication[m].cost + "</td></tr></table>");
                                    ...
                                    while (d < data[i].doctor.length) {
                                        $("#invoice").append("<table class='table'><tbody><td>Doctor: " + data[i].doctor[d].firstname + " " + data[i].doctor[d].lastname + "</td><td class='float-right'>Fee: $" + data[i].doctor[d].fee + "</td></tr></tbody></table>");
