                        ...
                        $("#getInvoice").change(function() {
                            ...
                            while (i < data.length) {
                                if (data[i].AdmissionID == $("#getInvoice").val()) {
                                    ...
                                    $("#invoice").append("<table class='table table-bordered'><tr><td>" + data[i].patient.id
                                        + " " + data[i].patient.firstname + " " + data[i].patient.lastname
                                        + "</td></tr><tr><td>" + data[i].patient.address + "</td></tr>");
                                    m = 0;
                                    subtotal = 0;
                                    while (m < data[i].medication.length) {
                                        $("#invoice").append("<table class='table table-bordered'><tr><td>Medication: " + data[i].medication[m].name + "</td><td>Quantity: " + data[i].medication[m].amount + "</td><td style='float: right'>Cost: $" + data[i].medication[m].cost + "</td></tr>");
                                    ...
                                    while (d < data[i].doctor.length) {
                                        $("#invoice").append("<table class='table table-bordered'><tr><td>Doctor: " + data[i].doctor[d].firstname + " " + data[i].doctor[d].lastname + "</td><td style='float: right'>Fee: $" + data[i].doctor[d].fee + "</td></tr>");
                                        fee += parseFloat(data[i].doctor[d].fee);
                                        d++;
                                    }
                                    due = subtotal + fee;
                                    $("#invoice").append("<table class='table table-bordered'><tr><td style='float: right'>Total Due: $" + due);
                                }
                                i++;
                            }
                        });
