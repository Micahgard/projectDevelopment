                        ...
                        $("#getInvoice").change(function() {
                            ...
                            while (i < data.length) {
                                if (data[i].AdmissionID == $("#getInvoice").val()) {
                                    $("#invoice").append("<table class='table table-borderless'><tr><td>" + data[i].patient.id + "</td>" +
                                        "<td>" + data[i].patient.firstname + " " + data[i].patient.lastname + "</td></tr><tr><td>"
                                        + data[i].patient.address + "</td></tr></table>");

                                    m = 0;
                                    subtotal = 0;
                                    while (m < data[i].medication.length) {
                                        $("#invoice").append("<table class='table table-borderless'><tr><td>Medication: " + data[i].medication[m].name + "</td><td>Quantity: " + data[i].medication[m].amount + "</td><td style='float: right'>Cost: $" + data[i].medication[m].cost + "</td></tr></table>");
